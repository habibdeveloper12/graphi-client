        ...
        plugins: {
          dragData: {
            ...
            onDragEnd: function (e, datasetIndex, index, value) {
              ...
              if (id) {
                fetch(
                  `https://graphi-server.onrender.com/api/v1/grap/multipleBar/${id}`,
                  {
                    method: "PATCH",
                    headers: {
    ...
    <div className=" h-full flex justify-center items-center">
      <div className="   mx-10 w-10/12 ">
        <div className=" w-full">
          ...
          <div
            ref={ref}
            className="relative  w-full bg-white mt-8 md:p-5 p-1 mb-10 md:my-0 md:mt-10 rounded-md shadow-md"
          >
            {isLoaded && (
              <Bar
                redraw={shouldRedraw}
            ...
            {(user || pathnme?.search) && (
              <div>
                ...
                <div>
                  <ReactToPrint
                    trigger={() => (
                      <button className="absolute left-10 -top-0 ">
                        <BiCloudDownload />
                      </button>
                    )}
                    content={() => ref.current}
